    ...
    class Board 
        attr_accessor :size
        attr_reader :board, :water
    def initialize(size)
        @size = size
        @water = '~'
        @board= Array.new(size) {Array.new(size, @water)}
    end
...
destroyer_1 = Ship.new(2, "Destroyer", 2, "D")
submarine_1 = Ship.new(3, "Submarine", 3, "S")
cruiser_1 = Ship.new(4, "Cruiser", 4, "C")
battleship_1 = Ship.new(5, "Battleship ", 5, "B")

destroyer_2 = Ship.new(2, "Destroyer", 2, "D")
submarine_2 = Ship.new(3, "Submarine", 3, "S")
cruiser_2 = Ship.new(4, "Cruiser", 4, "C")
battleship_2 = Ship.new(5, "Battleship ", 5, "B")
    ...
    if counter == 2
        ...
        p_one_input_one = gets.chomp.to_i
            if p_one_input_one > size and p_one_input_one >= 0
                puts "please pick a valid column number"
                redo
                else
                puts "Pick Row #"
                ...
                if p_one_input_two > size and p_one_input_one >= 0
                    puts "please pick a valid row  number"
                    redo
                    else
                        counter += 1
                end
