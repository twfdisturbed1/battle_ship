...
# cpuboard = Board.new(size, "cpu") 
# cpu = Cpu.new(cpuboard, new_board)
...
def end_game(new_board, cpuboard)
    player_place = 0
    cpu_place = 0
    ...
    # def show_opp_board(cpuboard)
    #     show_board(cpuboard)
    # end
    
    # def begin_game(new_board, cpuboard, cpu)
    #     intro = {ship1: "Destroyer = 2", ship2: "Submarine = 3", ship3: "Cruiser = 4", ship4: "Battle Ship = 5"} 
    #     show_opp_board(cpuboard); show_board(new_board)
    ...
    #                     if cpuboard.atk_cell(replyrow.to_i, replycol.to_i) != 'invalid shot'
    #                     # p hit_or_miss(cpuboard, replyrow, replycol)
    #                     break
    #                 end
    #             end
    #         end
    #             #    sleep(3)
    #             if end_game(new_board, cpuboard) != true
    #                 break
    #             end
    ...
    # end
    if end_game(new_board, cpuboard) != true
        puts end_game(new_board, cpuboard)
    end
# end
    # win_func()
    # begin_game(new_board, cpuboard, cpu)
